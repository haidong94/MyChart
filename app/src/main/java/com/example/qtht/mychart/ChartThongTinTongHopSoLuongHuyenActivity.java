...
public class ChartThongTinTongHopSoLuongHuyenActivity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    private void addControl() {
        ...
        tvchart.setText(getResources().getString(R.string.BieuDoThongTinTongHopSoLuongHuyen));
    }
