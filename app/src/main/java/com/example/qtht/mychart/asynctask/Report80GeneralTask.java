...
public class Report80GeneralTask extends AsyncTask<String,Void,ArrayList<Report80General>> {
    private static final String URL = "http://10.61.68.143:8088/QuanLyTaiKhoan.svc/LayChiTietBaoCao80TongHop?";
    ...
    Context context;
    ArrayList<Report80General> list=new ArrayList<>();
    ProgressDialog progressDialog;
    ICallListReport80General iCallListReport80Gerenal;

    public ArrayList<Report80General> getList() {
        return list;
    }

    public void setList(ArrayList<Report80General> list) {
        this.list = list;
    }

    public Report80GeneralTask(Context context){
        this.context=context;
        progressDialog=new ProgressDialog(context);
        this.iCallListReport80Gerenal= (ICallListReport80General) context;
    }



    @Override
    protected ArrayList<Report80General> doInBackground(String... params) {
        ...
        try{
            ...
            for (int i = 0; i < dulieus.length(); i++) {
                ...
                String SoNgay=c.getString("SONGAY");
                ...
                Report80General duLieu=new Report80General();

                duLieu.setKhamChuaBenh(KhamChuaBenh);
                duLieu.setSoLuot(SoLuot);
                duLieu.setSoNgay(SoNgay);
    ...
    @Override
    protected void onPostExecute(ArrayList<Report80General> costs) {
        super.onPostExecute(costs);
        iCallListReport80Gerenal.callListReport80General();
