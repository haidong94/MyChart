...
public class RecyclerReport80GeneralAdapter  extends RecyclerView.Adapter<RecyclerReport80GeneralAdapter.RecyclerViewHoder> {
    private List<Report80General> list;
    private Context context;

    public RecyclerReport80GeneralAdapter(List<Report80General> list, Context context){
        this.list=list;
    ...
    public RecyclerViewHoder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView=inflater.inflate(R.layout.item_report80general_activity,parent,false);
    ...
    public void onBindViewHolder(RecyclerViewHoder holder, int position) {
        ...
        holder.tv_songay.setText(list.get(position).getSoNgay());
        ...
        holder.tv_tienKham.setText(list.get(position).getTienGiuong());
    ...
    public class RecyclerViewHoder extends RecyclerView.ViewHolder {
        public TextView tv_tt,tv_khambenh,tv_soluot,tv_songay,tv_tongcong,tv_xetNghiem,tv_CDHA_TDCN,
        ...
        public RecyclerViewHoder(View itemView) {
            ...
            tv_songay= (TextView) itemView.findViewById(R.id.tv_songay);
